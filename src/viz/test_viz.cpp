...
int main(int argc, char** argv){
    FILE *fp_gt, *fp_img;
    // 请自行修改数据集路径
    fp_gt = fopen("/home/sun/data/MH_05_difficult/mav0/state_groundtruth_estimate0/data.csv", "r");
    fp_img = fopen("/home/sun/data/MH_05_difficult/mav0/cam0/data.csv", "r");
...
//        cout<<"pos: "<<pos.transpose()<<endl;
        ...
        cv::Mat img;
        string img_file = "/home/sun/data/MH_05_difficult/mav0/cam0/data/" + imgFileNames.front();
